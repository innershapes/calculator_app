...
class Calculator:
    ...
    def __init__(self, master):
        ...
        height=3, background='lightblue', foreground='black')
    ...
    def createButton(self, val, write=True, width=7):
        # this function creats a button, and takes one compulsory
        # argument, the value that should be on the button
    ...
    def click(self, text, write):
        ...
        # 'write argument' if True means the value 'val' should be written
        # on the screen, if None, should not be written on screen
        if write == None:
